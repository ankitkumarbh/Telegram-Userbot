...
if Var.LOAD_MYBOT == "True":
    USER_BOT_NO_WARN = (
        ...
        "\nPlease choose why you are here, from the available options\n\n".format(
            DEFAULTUSER, myid, MESAG, botname1
        )
    )
...
if Var.TG_BOT_USER_NAME_BF_HER is not None and tgbot is not None:
        ...
        if event.query.user_id == bot.uid and query.startswith("`Userbot"):
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Repo", "https://t.me/startearningsnow/")],
                    [
                        Button.url(
                            "Deploy Now!",
                            "https://t.me/startearningsnow/",
                        )
                    ],
                ],
            )
            ...
            result = builder.article(
                ...
                buttons=[
                    ...
                    [Button.url("Support", "https://t.me/startearningsnow/")],
                ],
            )
        else:
            result = builder.article(
                ...
                buttons=[
                    [custom.Button.url("Creator👨‍🦱", "https://t.me/ankitkumarbh/")],
                    [
                        custom.Button.url(
                            "👨‍💻Source Code‍💻", "https://github.com/ankitkumarbh/Tele-Bot"
                        ),
                        custom.Button.url(
                            "Deploy 🌀",
                            "https://t.me/startearningsnow/",
                    ...
                    [
                        custom.Button.url(
                            "Updates and Support Group↗️", "https://t.me/startearningsnow/"
                        )
                    ],
                ],
                link_preview=False,
    ...
    async def on_plug_in_callback_query_handler(event):
        if event.query.user_id == bot.uid:  # pylint:disable=E0602
            ...
            # https://github.com/ankitkumarbh/Tele-Bot
            await event.edit(buttons=buttons)
        else:
