    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "My Group", url="https://t.me/startearningsnow")],
                                  ]
                                  )
        else:
            await tgbot.send_message(event.chat_id,
...
async def logs(event):
    ...
    await tgbot.send_file(
        ...
        buttons=[
            ...
            [Button.url("Crashed?", "https://t.me/startearningsnow/")]
        ])
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://t.me/startearningsnow/")),
                          (Button.url("Deploy", url="https://t.me/startearningsnow/"))],
                         [Button.url("Support",
                                     url="https://t.me/startearningsnow/")]
                     ])
